        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand game-font fs-3" href="#">Merch</a>
                        ...
                        <ul class="navbar-nav d-flex">
                            <li class="nav-item">
                                <button class="btn btn-success snipcart-checkout">
                                    ...
                                    <span class="badge rounded-pill bg-warning text-dark snipcart-items-count">0</span>
                                </button>
                            </li>
                        </ul>
                    </div>
...
<div hidden id="snipcart" data-api-key="OWYyMGM0ZmQtMzg4NC00MzY2LTllYzgtZWNkMjFjZTU0YzM0NjM3NjQxOTU4NzAyNzQ0Njk1"></div>
